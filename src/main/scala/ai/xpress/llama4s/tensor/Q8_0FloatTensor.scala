...
final class Q8_0FloatTensor(val buffer: MemorySegment, val size: Int)(using fspecies: VectorSpecies[JFloat])
    extends FloatTensor {
  ...
  override def dot(offset: Int, other: FloatTensor, otherOffset: Int, size: Int): Float = {
    Q8_0TensorOps.vdot(this.asInstanceOf[FloatTensor], offset, other.asInstanceOf[FloatTensor], otherOffset, size)
  }
}
